...
export function densePath() { return buildDense(); }

export function resample(poly, stepM) {
...
export function sampleCurve(stepM) { return resample(buildDense(), stepM); }
